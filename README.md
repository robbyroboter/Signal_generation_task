...
Приложение предназначено для генерации и обработки простых дискретных сигналов. Пользователь может создать синусоидальный сигнал или меандр, посмотреть рассчитанные точки сигнала в таблице, получить основные характеристики сигнала и сохранить результат SQLite.
